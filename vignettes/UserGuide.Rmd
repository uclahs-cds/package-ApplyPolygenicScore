...
- PGS weight files form other sources that are imported independently must have the required columns: `CHROM`, `POS`, `effect_allele`, `beta`.
...
We see several things. First, a warning was printed by `merge.vcf.with.pgs`. This is a function called by `apply.polygenic.score` to merge vcf and pgs data by genomic coordinates.
...
head(merged.vcf.pgs.data$merged.vcf.with.pgs.data)
